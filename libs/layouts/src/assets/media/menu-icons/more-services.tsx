...
function MoreServicesSvg({ fill = '#585959', width, height }: MenuIconProps) {
  return (
    <svg width='20' height='20' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <g clip-path='url(#clip0_2375_9411)'>
        <path
...
export default MoreServicesSvg;
