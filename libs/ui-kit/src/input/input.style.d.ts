...
export declare const PasswordWrapper: any;
export declare const TextAreaWrapper: any;
export declare const SearchWrapper: any;
export declare const GroupWrapper: any;
export declare const InputMoneyWrapper: import("styled-components").IStyledComponent<"web", {
